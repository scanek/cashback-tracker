        ...
        {query.trim().length > 0 ? (
          <View style={styles.resultsContainer}>
            ...
            {filteredResults.length === 0 ? (
              ...
              <View style={[isTwoColumn && styles.twoColumnGrid]}>
                  ...
                  return (
                    <View
                      ...
                      style={[
                        styles.matchCard,
                        { backgroundColor: colors.card, borderColor: colors.cardBorder },
                        isTwoColumn && styles.twoColumnItem,
          ...
          <View style={styles.compactSection}>
            ...
            <View style={[styles.compactList, isTwoColumn && styles.twoColumnGrid]}>
          ...
          <View style={styles.spotlightSection}>
            ...
            <View style={[{ gap: 8 }, isTwoColumn && styles.twoColumnGrid]}>
